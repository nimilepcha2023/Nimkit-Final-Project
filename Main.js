...
instaClick.addEventListener('click',function(){
  ...
  //1) find a DOM object by its ID
  let cartupdate =document.querySelector("#harder-dom")

  // 2) find add to cart icon button
  let addtocartBtn = document.querySelector(".add-to-cart")
  // 3) Listen for user clicking on icon
 addtocartBtn.addEventListener('click', function() {
// 4) Once clicked, update the cart.
      let cartupdate = document.querySelector("#harder-dom")
